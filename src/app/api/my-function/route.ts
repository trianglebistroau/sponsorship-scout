...
//     console.log(`Processing POST request for username: ${username}`);

//     // Step 1: Call API A to get video URLs
//     const apiAUrl = `https://api-a.example.com/users/${username}/videos`;
...
//     // Extract video URLs (adjust based on actual API response structure)
//     let videoUrls;
//     if (Array.isArray(videoListData)) {
//       videoUrls = videoListData;
//     } else if (videoListData.videos) {
//       videoUrls = videoListData.videos;
//     } else if (videoListData.data) {
//       videoUrls = videoListData.data;
//     } else {
//       throw new Error('Unexpected API A response structure');
//     }
...
//         // Extract video ID or URL (adjust based on your video object structure)
//         const videoId = video.id || video.url || video;
//         const apiBUrl = `https://api-b.example.com/video/${videoId}/details`;
