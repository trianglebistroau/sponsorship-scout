...
const creatorArchetypes = {
  entertainer: {
    ...
    description:
      "You bring energy and laughter to everything you create. Your chaotic, fun personality draws people in and keeps them engaged.",
    strengths: [
  ...
  teacher: {
    ...
    color: "text-blue-500",
    description:
      "You have a gift for breaking down complex topics and helping others learn. Your authority and expertise shine through.",
    strengths: [
      "Clear communication",
      "Educational value",
      "Authority building",
  ...
  tastemaker: {
    ...
    description:
      "You have an eye for beauty and style. Your aesthetic sense and curation skills inspire others to elevate their lives.",
    strengths: [
      "Aesthetic vision",
      "Trendsetting ability",
      "Visual storytelling",
  ...
  friend: {
    ...
    color: "text-pink-500",
    description:
      "You're the creator people feel like they know personally. Your authenticity and relatability build deep connections.",
    strengths: [
  ...
  challenger: {
    ...
    description:
      "You motivate others to push their limits and achieve more. Your drive and determination are infectious.",
    strengths: [
...
const Onboarding = () => {
  ...
  const renderStep1 = () => (
    <div className="text-center animate-slideUp">
      ...
      <p className="text-muted-foreground mb-8 max-w-md mx-auto">
        We&apos;ll spot what&apos;s working (and what&apos;s not) so you can
        double down on the good stuff. Think of it as a vibe check
      </p>
      ...
      <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
        {[
          ...
          <Button
            key={option.key}
            variant={
              surveyAnswers.motivation === option.key ? "default" : "outline"
            }
      ...
      <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
        {[
          ...
          <Button
            key={option.key}
            variant={
              surveyAnswers.success === option.key ? "default" : "outline"
            }
      ...
      <div className="grid grid-cols-1 gap-4 max-w-md mx-auto">
        {[
          ...
          <Button
            key={option.key}
            variant={
              surveyAnswers.onCamera === option.key ? "default" : "outline"
            }
      ...
      <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
        {[
          ...
          <Button
            key={option.key}
            variant={
              surveyAnswers.editingStyle === option.key ? "default" : "outline"
            }
      ...
      <div className="grid grid-cols-1 gap-3 max-w-md mx-auto">
        {[
          ...
          <Button
            key={option.key}
            variant={
              surveyAnswers.personality === option.key ? "default" : "outline"
            }
  ...
  const renderStep7 = () => (
    <div className="text-center animate-slideUp">
      ...
      <h2 className="text-3xl font-bold mb-4">
        Analyzing Your Creator Identity
      </h2>
      <p className="text-muted-foreground mb-8">
        We're analyzing your responses and building your personalized creator
        profile...
      </p>
  ...
  const renderStep8 = () => {
    const archetype =
      creatorArchetypes[creatorType as keyof typeof creatorArchetypes];
