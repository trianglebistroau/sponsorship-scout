        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-slideUp">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              <span className="text-white">Hey Creator, </span>
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
              Ready to turn your TikTok into brand deals? You're in the right place. Think of us as your backstage pass to insights, ideas, and opportunities that'll make sponsors go, "We need them!"
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-20 animate-slideUp" style={{ animationDelay: '0.3s' }}>
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-6 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Personalised Content Analysis</h3>
              <p className="text-white/70">See what's working in your TikToks and what could get even better.</p>
            </Card>

            <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-6 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105">
              <Award className="w-12 h-12 text-yellow-300 mx-auto mb-4" />
              <h3 className="text-white font-semibold text-lg mb-2">Brand-Ready Recommendations</h3>
              <p className="text-white/70">Know exactly what brands want and how you can shine for them.</p>
            </Card>

            <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-6 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105">
              <Users className="w-12 h-12 text-primary-glow mx-auto mb-4" />
              <h3 className="text-white font-semibold text-lg mb-2">Idea Inspiration Engine</h3>
              <p className="text-white/70">Get fresh content ideas tailored to your favourite style and growth.</p>
            </Card>
          </div>

          <div className="mt-16 text-white/60 animate-slideUp" style={{ animationDelay: '0.6s' }}>
            <p className="text-sm">You're on the alpha and your insights can make us better for creators like you</p>
          </div>
        </div>
      </div>
    </div>
